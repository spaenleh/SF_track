defmodule TrackWeb.UserLiveTest do
  use TrackWeb.ConnCase

  import Phoenix.LiveViewTest
  import Track.AccountsFixtures

  @create_attrs %{name: "some name", email: "some email", is_admin: true}
  @update_attrs %{name: "some updated name", email: "some updated email", is_admin: false}
  @invalid_attrs %{name: nil, email: nil, is_admin: false}
